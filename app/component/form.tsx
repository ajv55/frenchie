...
import { usePup } from '../context/pupContext';
...
export default function Form() {
    ...
    const handleClick = async (e: React.MouseEvent<HTMLButtonElement>) => {
        e.preventDefault;
        if(setIsSuccess === undefined || setIsSuccess === null )  {
            throw new Error('Error when using the setter function')
        }
        setIsSuccess(true)
        ...
        if(response.status === 200) {
            ...
            toast.success(`Hey ${data.firstname}, you've successfully sent a message! `)
        }
  ...
  return (
    <div className=" bg-slate-900 w-full h-5/6 flex flex-col gap-7 justify-center items-end relative ">
        ...
        <h1 className={`${alex_brush.className} absolute text-white text-9xl top-3/4 left-56`}>Dior</h1>
            ...
            <form id='pup-form'  className="w-5/6 h-4/6 flex flex-col justify-center items-center border border-blue-300 p-10 rounded-xl bg-slate-200">
                <div className="relative z-0 w-full mb-5 group">
                    <input type="text" onChange={(e) => setData({...data, firstname: e.target.value })} value={data.firstname} name="firstname" id="firstname" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-purple-400 focus:outline-none focus:ring-0 focus:border-purple-600 peer" placeholder=" " required />
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input type="text" name="lastname" onChange={(e) => setData({...data, lastname: e.target.value })} value={data.lastname} id="lastname" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-purple-400 focus:outline-none focus:ring-0 focus:border-purple-600 peer" placeholder=" " required />
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <input type="email" name="email" onChange={(e) => setData({...data, email: e.target.value })} value={data.email} id="email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-purple-400 focus:outline-none focus:ring-0 focus:border-purple-600 peer" placeholder="" required />
                ...
                <div className="relative z-0 w-full mb-5 group">
                    <textarea  name="message" id="message" onChange={(e) => setData({...data, message: e.target.value })} value={data.message} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-purple-400 focus:outline-none focus:ring-0 focus:border-purple-600 peer" placeholder=" " required />
            ...
            <button onClick={handleClick}  type='button' form="pup-form"  className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
